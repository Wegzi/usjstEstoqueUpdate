...
public class ProdutoDAO {
    ...
    public void cadastrar(Produto produto) {
        ...
        String inserir = "INSERT INTO produto (codigo, nome, descricao, valor, estoque) VALUES (?, ?, ?, ?, ?) ";
        ...
        try (PreparedStatement pst = conexao.prepareStatement(inserir)) {
            ...
            System.err.println("Não foi possível manipulara tabela Produto.");
            ex.printStackTrace();
    ...
    public void alterar(Produto produto) {
        ...
        String alterar = "UPDATE produto SET nome = ?, descricao = ?, valor = ?, estoque = ? WHERE codigo = ? ";
